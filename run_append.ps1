...
# factors neutral
python main.py -p $proc_num -w fen -m a -b $append_date

# ic tests and ic tests neutral
python main.py -p $proc_num -w ic  -m a -b $append_date
python main.py -p $proc_num -w icn -m a -b $append_date
